...
class Notification(object):
    ...
    def __init__(
        ...
        # The priority of the notification. Specify ether PRIORITY_HIGH (10) or
        # PRIORITY_LOW (5) no se enviará If you don't set this, the APNs server will set the
        # priority to 10.
        self.priority = priority if priority else self.PRIORITY_HIGH
